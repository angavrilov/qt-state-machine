...
class QtSignalTransitionPrivate;
class Q_STATEMACHINE_CORE_EXPORT QtSignalTransition : public QtTransition
{
    Q_OBJECT
...
public:
    QtSignalTransition(QtState *sourceState = 0);
    QtSignalTransition(QObject *sender, const char *signal,
...
private:
    Q_DISABLE_COPY(QtSignalTransition)
    Q_DECLARE_PRIVATE(QtSignalTransition)
};
