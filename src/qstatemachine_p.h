...
class Q_STATEMACHINE_CORE_EXPORT QtStateMachinePrivate
#ifndef QT_STATEMACHINE_SOLUTION
...
public:
    ...
    QList<QtAbstractState*> exitStates(const QList<QtAbstractTransition*> &transitionList);
    void executeTransitionContent(const QList<QtAbstractTransition*> &transitionList);
    QList<QtAbstractState*> enterStates(const QList<QtAbstractTransition*> &enabledTransitions);
    ...
    void applyProperties(const QList<QtAbstractTransition*> &transitionList,
    ...
    void unregisterSignalTransition(QtSignalTransition *transition);
#ifndef QT_NO_STATEMACHINE_EVENTFILTER
    void registerEventTransition(QtEventTransition *transition);
    void unregisterEventTransition(QtEventTransition *transition);
#endif
    void unregisterTransition(QtAbstractTransition *transition);
