...
class Q_STATEMACHINE_CORE_EXPORT QtStateMachine : public QObject
{
    Q_OBJECT
...
public:
    ...
    QtAbstractState::RestorePolicy globalRestorePolicy() const;
    void setGlobalRestorePolicy(QtAbstractState::RestorePolicy restorePolicy);
...
#endif
    QtStateMachine(QtStateMachinePrivate &dd, QObject *parent);
